    ...
    subcategories: [
      {
        ...
        products: [
          ...
          },
          {
            ...
            detailedDescription: 'میلگرد فولادی 20MnV6 روکش کروم سخت از فولاد کم‌کربن منگنز-وانادیوم ساخته شده که به‌طور گسترده در ساخت شافت‌هایی که نیاز به چقرمگی بالا و مقاومت ضربه‌ای دارند استفاده می‌شود. ترکیب شیمیایی منحصربه‌فرد و خواص مکانیکی این ماده، آن را برای کاربردهای مختلف مهندسی مکانیک و سازه‌ای مناسب ساخته است.',
            features: ['چقرمگی و مقاومت ضربه‌ای بالا: مناسب برای قطعاتی که تحت بارهای دینامیکی یا ارتعاشات قرار دارند مانند شافت‌های محرک و میل‌لنگ‌ها', 'استحکام متوسط: افزودن منگنز و وانادیوم استحکام کششی و فشاری را بهبود می‌بخشد', 'قابلیت جوشکاری عالی: کمتر مستعد ترک‌خوردگی در فرآیند جوشکاری', 'قابلیت ماشین‌کاری خوب: مناسب برای تراشکاری، فرزکاری و سوراخ‌کاری دقیق', 'پایداری ابعادی برتر: حفظ دقت ابعادی پس از عملیات حرارتی', 'عملکرد حرارتی مطلوب: پاسخ‌دهی خوب به نرمال‌سازی و کوئنچ-تمپر', 'مقاومت خوردگی: روکش کروم سخت مقاومت در برابر خوردگی را افزایش می‌دهد'],
            applications: ['شافت‌های مکانیکی و محرک', 'میلگردهای سیلندر هیدرولیک', 'میل‌لنگ‌های ماشین‌آلات سنگین', 'شافت‌های انتقال نیرو', 'قطعات سازه‌ای صنعتی', 'تجهیزات بالابر و جرثقیل'],
          ...
          },
          {
            ...
            detailedDescription: 'فولاد 38MnVS6 یک فولاد کربنی متوسط منگنز-وانادیوم-گوگرد است که به دلیل تعادل عالی بین استحکام و چقرمگی شناخته شده است. این ماده به‌طور مکرر در ساخت شافت‌هایی استفاده می‌شود که نیاز به ظرفیت تحمل بار بالا و مقاومت سایشی برتر دارند.',
            features: ['استحکام و سختی بالا: مناسب برای قطعات مکانیکی تحت بارهای سنگین مانند شافت‌های محرک و میل‌لنگ‌ها', 'چقرمگی عالی: عملکرد قابل اعتماد در محیط‌های پربار و ضربه‌ای بدون خطر شکست ترد', 'مقاومت سایشی برتر: سختی سطحی بالا پس از عملیات حرارتی، ایده‌آل برای قطعات با اصطکاک طولانی‌مدت', 'قابلیت ماشین‌کاری بهبود یافته: حاوی مقدار کنترل‌شده گوگرد برای بهبود تراشکاری و فرزکاری', 'عملکرد حرارتی عالی: پاسخ‌دهی خوب به کوئنچ و تمپر (Q&T) برای تنظیم دقیق سختی', 'قابلیت جوشکاری: امکان مونتاژ و تعمیر با پیش‌گرمایش و عملیات پس از جوش', 'پایداری ابعادی: حفظ دقت ابعادی در طول عملیات حرارتی', 'مقاومت ضربه‌ای: تحمل محیط‌های پرضربه و ارتعاشی مانند ماشین‌آلات سنگین'],
            applications: ['صنایع خودروسازی - سیستم‌های انتقال نیرو', 'ماشین‌آلات سنگین - شافت‌های محرک', 'تجهیزات هیدرولیک - میلگردهای پیستون', 'تجهیزات حمل‌ونقل سنگین', 'شافت‌های دوار صنعتی', 'میل‌لنگ‌ها و اتصالات مکانیکی'],
        ...
        products: [
          {
            ...
            detailedDescription: 'میلگرد فولادی S45C القایی روکش کروم سخت از طریق سخت‌کاری القایی (فرکانس بالا) عملکرد فوق‌العاده‌ای کسب می‌کند. این فرآیند سختی سطحی و مقاومت سایشی را به‌شدت افزایش می‌دهد در حالی که چقرمگی اساسی هسته مواد حفظ می‌شود. ساختار "پوسته سخت، هسته چقرمه" اجازه می‌دهد میلگرد ضربات داخلی و بارهای دینامیکی را تحمل کند.',
            features: ['سختی سطحی بالا (HRC 53±2): مقاومت عالی در برابر سایش و فرسودگی', 'مقاومت سایشی برتر: لایه سخت‌شده تخصصی روی سطح', 'چقرمگی عالی هسته: حفظ مقاومت ضربه‌ای ذاتی ماده S45C', 'استحکام خستگی بالا: تنش فشاری پسماند سطحی مقاومت خستگی را بهبود می‌بخشد', 'انعطاف‌پذیری پردازش: هسته قابل ماشین‌کاری پس از عملیات حرارتی', 'کنترل ابعادی دقیق: تأثیر حرارتی محدود به سطح', 'مقاومت خوردگی بهبود یافته: ترکیب سخت‌کاری القایی با روکش کروم'],
            applications: ['یاتاقان‌ها و بوشینگ‌ها', 'شافت‌های حرکت خطی', 'ماشین‌آلات خودکار', 'ستون‌های دستگاه تزریق پلاستیک', 'سیستم‌های هیدرولیک', 'تجهیزات اتوماسیون صنعتی'],
          ...
          },
          {
            ...
            detailedDescription: 'میلگرد فولادی S55C القایی روکش کروم سخت بالاترین سطح سختی سطحی (HRC 60±3) را در بین محصولات این دسته ارائه می‌دهد. فولاد پرکربن S55C با سخت‌کاری القایی ترکیبی از سختی فوق‌العاده سطحی و چقرمگی هسته را فراهم می‌کند که آن را برای کاربردهای با بار سنگین و سایش شدید ایده‌آل می‌سازد.',
            features: ['سختی سطحی بسیار بالا (HRC 60±3): بالاترین سطح مقاومت سایشی', 'مقاومت سایشی برتر: عمر طولانی در شرایط اصطکاک مداوم', 'استحکام خستگی عالی: عمر خستگی طولانی‌تر در محیط‌های تنش تکراری', 'پایداری ابعادی: حفظ دقت ابعادی در طول استفاده', 'چقرمگی هسته مناسب: جلوگیری از شکست ترد', 'انعطاف‌پذیری پردازش: امکان تنظیمات نهایی پس از عملیات حرارتی', 'مقاومت خوردگی بهبود یافته: ترکیب سخت‌کاری القایی با روکش کروم سخت'],
            applications: ['یاتاقان‌های صنعتی با بار سنگین', 'شافت‌های حرکت خطی (Linear Guide Rods)', 'ماشین‌آلات خودکار با سرعت بالا', 'ستون‌های دستگاه تزریق پلاستیک', 'تجهیزات CNC و ماشین‌کاری دقیق', 'سیستم‌های رباتیک صنعتی'],
          ...
          },
          {
            ...
            detailedDescription: 'از طریق سخت‌کاری القایی، عملکرد میلگرد فولادی 20MnV6 به‌طور قابل توجهی بهبود می‌یابد. این فرآیند سختی سطحی و مقاومت سایشی را به‌شدت افزایش می‌دهد در حالی که چقرمگی اساسی هسته مواد حفظ می‌شود. ساختار "پوسته سخت، هسته چقرمه" این میلگرد را برای کاربردهای سنگین ایده‌آل می‌سازد.',
            features: ['سختی سطحی بالا (HRC 50+): مقاومت عالی در برابر سایش و فرسودگی', 'مقاومت سایشی برتر: لایه سخت‌شده تخصصی برای قطعات با اصطکاک مداوم', 'چقرمگی عالی هسته: ساختار "پوسته سخت، هسته چقرمه" برای کاهش خطر شکست ترد', 'استحکام خستگی بالا: تنش فشاری پسماند سطحی برای بهبود مقاومت خستگی', 'انعطاف‌پذیری پردازش: هسته قابل ماشین‌کاری برای تنظیمات نهایی', 'کنترل ابعادی دقیق: تأثیر حرارتی محدود به سطح، حفظ دقت بالا', 'مقاومت خوردگی بهبود یافته: ترکیب سخت‌کاری القایی با روکش کروم سخت'],
            applications: ['مکانیزم‌های انتقال نیرو سنگین', 'شافت‌های سیستم هیدرولیک', 'شافت‌های محرک و انتقال', 'شافت‌های دوار صنعتی', 'تجهیزات بالابر و جرثقیل', 'ماشین‌آلات ساختمانی و معدنی'],
          ...
          },
          {
            ...
            detailedDescription: 'میلگرد فولادی 38MnVS6 القایی روکش کروم سخت از طریق سخت‌کاری القایی ترکیبی برتر از سختی سطحی بالا و هسته چقرمه را ارائه می‌دهد. این محصول به‌ویژه برای کاربردهایی مناسب است که نیاز به استحکام بالا، حداکثر مقاومت سایشی و عملکرد خستگی بالا دارند.',
            features: ['سختی سطحی بالا (HRC 50-60+): افزایش چشمگیر مقاومت سایشی', 'مقاومت سایشی عالی: عمر طولانی در شرایط سایش شدید بدون از دست دادن مواد', 'چقرمگی خوب هسته: جذب ضربات و بارهای دینامیکی بدون خطر شکست ترد', 'استحکام خستگی بالا: عمر خستگی طولانی‌تر در محیط‌های تنش تکراری و فرکانس بالا', 'انعطاف‌پذیری پردازش: امکان تنظیمات مکانیکی نهایی پس از سخت‌کاری', 'پایداری ابعادی: تأثیر حرارتی محدود به سطح، حفظ دقت و پایداری', 'مقاومت خوردگی: ترکیب سخت‌کاری سطحی با روکش کروم برای حفاظت برتر'],
            applications: ['سیستم‌های انتقال نیرو خودرو', 'قطعات متحرک ماشین‌آلات سنگین', 'شافت‌های حساس تجهیزات صنعتی دقیق', 'تجهیزات حمل‌ونقل سنگین', 'سیستم‌های هیدرولیک فشار بالا', 'ماشین‌آلات معدنی و ساختمانی'],
